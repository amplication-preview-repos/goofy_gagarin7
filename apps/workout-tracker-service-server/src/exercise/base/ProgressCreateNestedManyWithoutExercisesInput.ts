...
@InputType()
class ProgressCreateNestedManyWithoutExercisesInput {
...
export { ProgressCreateNestedManyWithoutExercisesInput as ProgressCreateNestedManyWithoutExercisesInput };
